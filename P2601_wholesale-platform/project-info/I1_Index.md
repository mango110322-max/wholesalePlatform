...
P2601_wholesale-platform

## 项目简介

服装批发平台练习项目，用于熟悉 AI 在产品经理、交互设计师、视觉设计师、前端开发、后端开发、测试等岗位工作流中的使用方式。当前已建立项目大脑和阶段工作区，准备展开具体电商产品设计。产品的详细介绍请见 [A1](./A1_Architecture_Product.md)。
...
Model                         Function
-----                         --------
P2601_wholesale-platform      项目名称
├── project-info/             项目信息文件夹，承载结构、计划、任务、资料等非源码内容
│   ├── instruction           项目结构使用说明，记录编号规则、模块约定和日志规则
...
│   │   ├── G1_Goal           用于存放目标的模块
│   │   ├── S1_Summary        用于存放项目介绍的模块，可以通过 5W 的方式描述
│   │   └── H1_How            记录达成目标需要做哪些事，给出清晰的步骤
│   ├── T1_Task               拆解出具体的任务
│   │   ├── Todo              以表格形式记录需要完成的任务
│   │   └── Archive           归档已完成任务
│   └── RelatedDocs/          相关文档文件夹
...
| 想看什么 | 去哪里看 | 说明 |
| --- | --- | --- |
| 项目有哪些模块、模块在哪里 | `project-info/I1_Index.md` | 先从这里熟悉项目结构 |
| 项目结构如何使用 | `project-info/instruction.md` | 看编号规则、模块约定和日志规则 |
| 项目介绍 | `project-info/Plan.md` 的 `S1_Summary` | 用 5W 了解项目背景 |
| 项目目标 | `project-info/Plan.md` 的 `G1_Goal` | 看本项目要达成什么 |
